      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">SQL Examples</p>
          </div>
        </div>
        <div class="content"> Example SQL queries and solutions. </div>
      </div>
    </div>
  </div>
  ...
  <div class="column is-one-third">
    <div class="card">
      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">Fraud Detection Project</p>
          </div>
        </div>
        <div class="content"> Fraud detection project details. </div>
      </div>
    </div>
  </div>
  ...
  <div class="column is-one-third">
    <div class="card">
      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">Forecasting Mini-Course Sales</p>
          </div>
        </div>
        <div class="content"> Kaggle forecasting mini-course sales. </div>
      </div>
    </div>
  </div>
  ...
  <div class="column is-one-third">
    <div class="card">
      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">Predicting Credit Approval</p>
          </div>
        </div>
        <div class="content"> Kaggle project on predicting credit approval. </div>
      </div>
    </div>
  </div>
  ...
  <div class="column is-one-third">
    <div class="card">
      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">Austin Violent Crime Insights Dashboard</p>
          </div>
        </div>
        <div class="content"> Tableau dashboard on Austin violent crime insights. </div>
      </div>
    </div>
  </div>
  ...
  <div class="column is-one-third">
    <div class="card">
      ...
      <div class="card-content">
        <div class="media">
          <div class="media-content">
            <p class="title is-4">Police Shootings Analysis</p>
          </div>
        </div>
